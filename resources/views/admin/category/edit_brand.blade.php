                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/admin/brands') }}">Category</a></li>
                                ...
                                <form method="POST" action="{{ url('update/brand/'.$brand->id) }}">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputCategory">Update Brand</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputCategory">Update Brand Logo</label>
                                            <input type="file" class="form-control" value="{{ $brand->brand_logo }}" id="exampleInputBrand" name="brand_logo">
                                        </div>
